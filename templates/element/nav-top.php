    ...
    <ul class="nav navbar-nav">					
      ...
      <li class="dropdown user user-menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
          <?php echo $this->Html->image('default_profile_pic.png', array('class' => 'user-image', 'alt' => 'User Image')); ?>
        ...
        <ul class="dropdown-menu">
          ...
          <li class="user-header">
            ...
            <p>
				...
				$session = $this->getRequest()->getSession();
				if($session->read('user')){
					echo "Logged in as: ".$session->read('user.first_name').' '.$session->read('user.last_name');
          ...
          <li class="user-footer">
            ...
            <div class="pull-right">
				<?php echo $this->Html->link('Sign out','/Users/logout', ['class'=>'btn btn-default bnt-flat']); ?>
            </div>
          </li>
        </ul>
      </li>
